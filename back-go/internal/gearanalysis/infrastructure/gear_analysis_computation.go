...
var bikeMaintenanceRules = []gearMaintenanceRule{
	...
	{component: "VALVE_CORE_FRONT", label: "Front valve core", intervalMonths: 12},
	{component: "VALVE_CORE_REAR", label: "Rear valve core", intervalMonths: 12},
	{component: "WHEEL_TRUING", label: "Wheel truing", intervalDistance: 3000 * 1000},
