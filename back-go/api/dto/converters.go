...
func ToDashboardDataDto(data business.DashboardData) DashboardDataDto {
	return DashboardDataDto{
		...
		MaxDistanceDateByYear:             data.MaxDistanceDateByYear,
		AverageDistanceByActiveDayByYear:  data.AverageDistanceByActiveDayByYear,
		MaxDistanceByActiveDayByYear:      data.MaxDistanceByActiveDayByYear,
		MaxDistanceByActiveDayDateByYear:  data.MaxDistanceByActiveDayDateByYear,
		...
		MaxElevationDateByYear:            data.MaxElevationDateByYear,
		AverageElevationByActiveDayByYear: data.AverageElevationByActiveDayByYear,
		MaxElevationByActiveDayByYear:     data.MaxElevationByActiveDayByYear,
		MaxElevationByActiveDayDateByYear: data.MaxElevationByActiveDayDateByYear,
