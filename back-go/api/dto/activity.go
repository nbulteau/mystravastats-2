...
type ActivityDto struct {
	...
	BestTimeForDistanceFor1000m      string `json:"bestTimeForDistanceFor1000m"`
	BestElevationForDistanceFor500m  string `json:"bestElevationForDistanceFor500m"`
	BestElevationForDistanceFor1000m string `json:"bestElevationForDistanceFor1000m"`
