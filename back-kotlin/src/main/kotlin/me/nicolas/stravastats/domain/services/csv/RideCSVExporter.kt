...
internal class RideCSVExporter(clientId: String, activities: List<StravaActivity>, year: Int) :
    CSVExporter(clientId, activities, year, ActivityType.Ride) {
        ...
        return activities.joinToString("\n") { activity ->
            writeCSVLine(
                listOf(
                    ...
                    activity.calculateBestTimeForDistance(250.0)?.getFormatedSpeed() ?: "",
                    activity.calculateBestTimeForDistance(500.0)?.getFormatedSpeed() ?: "",
                    ...
                    activity.calculateBestTimeForDistance(20000.0)?.getFormatedSpeed() ?: "",
                    activity.calculateBestTimeForDistance(50000.0)?.getFormatedSpeed() ?: "",
                    activity.calculateBestTimeForDistance(100000.0)?.getFormatedSpeed() ?: "",
