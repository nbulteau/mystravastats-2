...
class RoutesController(
    ...
    companion object {
        private const val DEFAULT_VARIANT_COUNT = 4
    ...
    fun generateTargetRoutes(
        ...
        val startDirection = normalizeStartDirection(payload.startDirection)
        ...
        return GenerateRoutesResponseDto(routes = routes)
    }
