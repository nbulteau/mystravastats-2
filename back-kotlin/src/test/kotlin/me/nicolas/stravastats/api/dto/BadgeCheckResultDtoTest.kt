...
class BadgeCheckResultDtoTest {
    ...
    fun `famous climb result exposes print-ready poster details`() {
        ...
        assertEquals(1100, details.ascents.first().comparisonPoints.last().elapsedSeconds)
        assertEquals(220, details.ascents.first().comparisonPoints[1].powerWatts)
        assertEquals("high", details.ascents.first().comparisonQuality.precision)
