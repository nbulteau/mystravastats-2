...
import { asRecord, normalizeDataQualitySummary, normalizeDataQualityIssue, numberRecord, textValue, numberValue, booleanValue, sourceSyncChangedActivityData, listValues, recordList, displayList, yesNo, inferProvider, formatProvider, formatFITSourceKind, formatFITDeviceSyncStatus, formatDateTime, formatEpochMs, formatBytes, formatInteger, formatMeters, formatSignedMeters, formatDistanceMeters, formatSignedDistance, formatDurationSeconds, formatSignedDurationSeconds, formatSpeed, formatSignedSpeedDelta, statusClass, fileStatusClass, normalizeSourceMode } from "@/services/diagnostics-formatters";
import { correctionLabel, dataQualityActionForIssue, dataQualityActionLabel, dataQualityCategoryPriority, dataQualityCategoryTooltip, dataQualityImpactTokens, dataQualitySeverityClass, dataQualityStatClass, formatCompositeConflict, formatDataQualityCategory, formatDataQualityImpactToken, formatSourceField } from "@/services/diagnostics-presentation";
...
const compositeConflictRows = computed(() =>
  recordList(composite.value.conflictSamples).map((conflict) => formatCompositeConflict(conflict, activeConfiguredProviders.value)),
);
...
<style scoped src="../assets/views/diagnostics-view.css"></style>
